...
const Subnautica = (0, import_index_2dda268c.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_2dda268c.v)(import_game_7d8662af.G, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
    default: () => `<p>Why did I wait so long to play this. The game still looks great, wide
variety of unique creatures and plants.</p>`
  })}`;
});
